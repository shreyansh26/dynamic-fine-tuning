...
from utils.parse_answer import strip_string
...
def math_equal(
    ...
    # Normalize LaTeX and formatting (e.g., remove \left/\right, spaces, units)
    # so forms like (3,\frac{\pi}{2}) and \left( 3, \frac{\pi}{2} \right) compare equal.
